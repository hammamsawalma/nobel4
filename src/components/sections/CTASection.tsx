    ...
    return (
        <section className="relative py-32 overflow-hidden bg-forest z-20">
            ...
            <div className="absolute inset-0 z-0 opacity-20 hidden md:block">
                <ParallaxImage src="/images/sections/cta-bg.webp" alt="Background" className="w-full h-full" speed={0.15} />
            </div>
            {/* Fallback for smaller screens / simplified rendering */}
            <div className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat md:hidden" style={{ backgroundImage: "url('/images/sections/cta-bg.webp')" }} />
